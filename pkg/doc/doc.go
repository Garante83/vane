		...
		return []Page{
			{
				...
				Content: []string{
					...
					"  Um IP-Adressen nicht manuell ermitteln oder eingeben zu müssen, wird dem",
					"  Befehl einfach 'vane' vorangestellt. Die Übersetzung erfolgt über eine",
					"  dynamische Notation.",
					"",
					"  Vane übersetzt diese Token in Millisekunden in die aktiven IP-Adressen",
					"  und übergibt die Ausführung nahtlos an das Betriebssystem (Handoff-Prinzip).",
					"",
					"  💡 BEDIENUNGSBEISPIEL:",
					"    vane ssh admin@\"eno1|>...gw\"",
					"",
					"    Wird im Hintergrund automatisch übersetzt und ausgeführt als:",
					"    ssh admin@192.168.178.1  (sofern 192.168.178.1 das aktive Standard-Gateway ist)",
					"",
					"  🔥 AUTOMATISCHES PORT-MAPPING:",
					"    Wird bei ssh oder scp ein Port angegeben (z. B. 'eno1|>...gw:2222'),",
					"    formatiert Vane diesen automatisch in die passende Flag des Zielbefehls um (-p bzw. -P).",
				},
			},
			{
				...
				Content: []string{
					...
					"  basierend auf der konfigurierten IP und Netzmaske.",
					"",
					...
					"    Ersetzt das letzte Segment der eigenen Schnittstellen-IP.",
					"    Beispiel (Eigene IP: 192.168.178.53):",
					"    eno1|>...33  -->  192.168.178.33",
					"",
					"  📌 MEHRERE OKTETTE ÜBERSCHREIBEN (..wert.wert):",
					"    Ersetzt die hinteren 2 oder 3 Segmente der eigenen IP.",
					"    Beispiel: eno1|>..100.33  -->  192.168.100.33",
					"",
					"  📌 DUAL-STACK (IPv6 ULA):",
					"    Die Notation verhält sich in lokalen IPv6-ULA-Netzwerken vollkommen analog.",
				},
			},
			{
				Title: "🔒 3. MAC-Matching & WAN-Notation (|<)",
				Content: []string{
					"  Der Operator '|<' dient dem Filtern nach globalen Adressen sowie der",
					"  Auflösung von Geräten über Hardware-Adressen (MAC).",
					"",
					"  📌 AUTOMATISCHES MAC-MATCHING (|<...mac):",
					"    Vane ermittelt die IP eines Geräts im Subnetz über das Ende seiner",
					"    MAC-Adresse oder EUI-64, indem es die ARP-Tabelle des Kernels analysiert.",
					"    Beispiel: eno1|<...3e8e  -->  192.168.178.53",
					"",
					"  📌 INTELLIGENTE SCHUTZGRENZE (> 255):",
					"    Eingaben größer als 255 werden automatisch als hexadezimale MAC-Endungen",
					"    interpretiert, um eine fehlerhafte IP-Generierung zu verhindern.",
					"",
