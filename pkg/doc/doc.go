		...
		return []Page{
			...
			},
			{
				...
				Content: []string{
					...
					"    Beispiel IPv6 (Eigene IP: fd00::...:3e8e): eno1|>...33 --> fd00::...:33",
					"",
					"  📌 LOCALHOST & LOOPBACK (|:):",
					...
					"",
					"  📌 APIPA FALLBACK (|!):",
					"    Rettungsanker bei fehlgeschlagenen DHCP-Leases (169.254.x.x).",
					"    Beispiel: 1|!...34  -->  169.254.0.34",
				},
			},
			{
				...
				Content: []string{
					...
					"    Gerät im Subnetz über das Ende seiner MAC-Adresse aufzulösen.",
					"    Beispiel: eno1|<...cf46  -->  192.168.178.35",
					"",
	...
	return []Page{
		...
		},
		{
			...
			Content: []string{
				...
				"    Example IPv6 (Your IP: fd00::...:3e8e): eno1|>...33 --> fd00::...:33",
				"",
				"  📌 LOCALHOST & LOOPBACK (|:):",
				...
				"",
				"  📌 APIPA FALLBACK (|!):",
				"    Safety net for failed DHCP leases (169.254.x.x).",
				"    Example: 1|!...34  -->  169.254.0.34",
			},
		},
		{
			Title: "🔒 3. MAC-Matching & WAN Notation (|<)",
